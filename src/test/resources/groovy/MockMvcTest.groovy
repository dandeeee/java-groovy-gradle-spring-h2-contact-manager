...
////
////        def contacts = appService.listContact()
////        assert !contacts
////
////        def contactTypes = appService.listContactType()
////        assert contactTypes
////
...
////                .andExpect(MockMvcResultMatchers.redirectedUrl("/index"))
////
////        contacts = appService.listContact()
////
////        assert contacts
////        assert contacts[0].id
////
////        appService.removeContact(contacts[0].id)
////
////    }
////
////    @Test
